...
exports.execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const commitTemplate = commits.filter(commit => !pullTitles.includes(commit.raw)).map(commit => misc_1.replaceVariables(commit.indent ? misc_1.getChildCommitTemplate() : misc_1.getCommitTemplate(), [
