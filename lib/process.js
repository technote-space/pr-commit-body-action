...
exports.execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const commitTemplate = commits.filter(commit => !pullTitles.includes(commit.original)).map(commit => misc_1.replaceVariables(commit.isChild ? misc_1.getChildCommitTemplate() : misc_1.getCommitTemplate(), [
