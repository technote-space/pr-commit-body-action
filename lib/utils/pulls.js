...
exports.getMergedPulls = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (isFilter ? pulls.map(item => (Object.assign(Object.assign({}, item), github_action_version_helper_1.Misc.parseCommitMessage(item.title, types, exclude, [])))).filter(item => item.type) : pulls)
