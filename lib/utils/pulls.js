...
const getMergedPulls = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const types = misc_1.getCommitTypes();
    const exclude = misc_1.getExcludeMessages();
    const isFilter = misc_1.isFilterPulls();
    const pulls = yield octokit.paginate(octokit.pulls.list, Object.assign(Object.assign({}, context.repo), { base: github_action_helper_1.Utils.getPrBranch(context), state: 'closed' }));
    return (isFilter ?
        pulls
