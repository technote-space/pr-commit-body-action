...
const getTemplate = (isEmpty) => isEmpty ? exports.getNoItems() : core_1.getInput('TEMPLATE', { required: true });
...
const getMaxCommitNumber = () => /^\d+$/.test(core_1.getInput('MAX_COMMITS')) ? Number(core_1.getInput('MAX_COMMITS')) : 5; // eslint-disable-line no-magic-numbers
...
const isFilterPulls = () => github_action_helper_1.Utils.getBoolValue(core_1.getInput('FILTER_PR'));
